...
const BASE_URL3 = 'https://anitaku.to';
const BASE_URL2 = 'https://anitaku.to/';
const ajax_url = 'https://ajax.gogocdn.net/';
const anime_info_url = 'https://anitaku.to/catagory/';
const anime_movies_path = '/anime-movies.html';
const popular_path = '/popular.html';
const new_season_path = '/season.html';
const search_path = '/search.html';
const popular_ongoing_url = `${ajax_url}popular.html`;
const recent_release_url = `${ajax_url}season.html`;
const list_episodes_url = `${ajax_url}ajax/load-list-episode`;
const seasons_url = 'https://anitaku.to/season.html';
